...
test("should allow usr to register", async ({ page }) => {
  ...
  await page.locator("[name=firstName]").fill("e2e_test_firstName");
  await page.locator("[name=lastName]").fill("e2e_test_lastName");
